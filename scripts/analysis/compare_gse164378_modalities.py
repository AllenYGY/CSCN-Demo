...
def _load_or_compute_ckm(
    ...
    *,
    ...
    if object_path.is_file():
        ...
        matrix = np.load(_matrix_path(run_dir, group_key))
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Compare GSE164378 RNA baseline and CSCN CKM representations across modalities."
    )
    parser.add_argument(
        "--rna-expr-path",
        type=Path,
