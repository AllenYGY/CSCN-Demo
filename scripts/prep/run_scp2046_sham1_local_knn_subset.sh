...
TMP_DIR="${TMPDIR:-/tmp}/cscn_scp2046_sham1_local_knn_subset"
mkdir -p "${TMP_DIR}"
export CSCN_REPO_ROOT="${REPO_ROOT}"
export CSCN_TMP_DIR="${TMP_DIR}"
export CSCN_RUN_NAME="scp2046_sham1_local_knn_subset"
export CSCN_SPATIAL_STRATEGY="local_knn_subset"
